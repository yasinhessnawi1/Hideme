...
export const useAuth = (): UseAuthReturn => {
    ...
    // Note: Session expired and too many requests events are now handled by useAutoLogout hook
    // This avoids duplicate event handling and provides a centralized logout mechanism
