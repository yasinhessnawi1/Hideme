...
// Mock dependencies
vi.mock('../services/PDFStorageService', () => ({
    default: {
...
const TestConsumer = () => {
    ...
    return (
        <div>
            ...
            <button data-testid="add-file" onClick={() => addFile(new File([], 'test.pdf', { type: 'application/pdf' }))}>Add File</button>
            ...
            <button data-testid="toggle-selection" onClick={() => toggleFileSelection(files[0])}>Toggle Selection</button>
            ...
            <button data-testid="add-to-active-files" onClick={() => addToActiveFiles(files[0])}>Add to Active Files</button>
            <button data-testid="remove-from-active-files" onClick={() => removeFromActiveFiles(files[0])}>Remove from Active Files</button>
            <button data-testid="toggle-active-file" onClick={() => toggleActiveFile(files[0])}>Toggle Active File</button>

            <button data-testid="toggle-storage" onClick={() => setStoragePersistenceEnabled(!isStoragePersistenceEnabled)}>Toggle Storage</button>
